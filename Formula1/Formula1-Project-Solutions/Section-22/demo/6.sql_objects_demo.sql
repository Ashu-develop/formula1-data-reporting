...
-- MAGIC %python
-- MAGIC race_results_df = spark.read.parquet("/mnt/dataisreportingdl/processed/lap_times")

-- COMMAND ----------

-- MAGIC %python
-- MAGIC race_results_df.write.format("parquet").mode("ignore").saveAsTable("demo.lap_times_python")
